...
public:
	...
	*/
	...
	afx_msg void			OnBnClickedBtnChartRun();
	...
	void					DataSave_FSR(float fTime, double FSR1, double FSR2, double FSR3, double FSR4, double FSR5, double FSR6, double trigger, double errorComm);
	void					SaveSettings();
	void					LoadSettings();
	void					CalcFeedBack();
	float					CalcVwObv();
	...
	double m_dataSeriesA8[sampleSize];	// The values for the data series A8
